"""
Django settings for pai_bank project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://pai-bank.onrender.com', 'https://*.127.0.0.1']
...
WSGI_APPLICATION = 'pai_bank.wsgi.application'
